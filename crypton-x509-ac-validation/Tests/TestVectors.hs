...
data TestCategory
    = -- | 4.1 Signature Verification (AC-SIG-*)
      CatSignature
    | -- | 4.2 Validity Periods (AC-VAL-*)
      CatValidity
    | -- | 4.3 Issuer/Name Chaining (AC-ISS-*)
      CatIssuer
    | -- | 4.6 Basic Constraints (AC-BC-*)
      CatBasicConstraints
    | -- | 4.7 Key Usage (AC-KU-*)
      CatKeyUsage
    | -- | 4.4 Revocation (AC-REV-*)
      CatRevocation
...
basicConstraintsTestCases =
    ...
    , -- \| AC-BC-4.3: RFC 5280 Section 4.2.1.9 -- cA=FALSE (non-critical).
      ...
      TestCase
        ...
        , tcDescription =
            "AA certificate has basicConstraints with cA=false (non-critical)"
        , tcCategory = CatBasicConstraints
        , tcExpected = ExpectError "AANotCA"
        }
