...
testACRevoked = do
    ...
    case checkACRevocation
        currentDateTime
        (Just acrl)
        Nothing
        aaCert
        (acpSignedAC acPair) of
...
testV1FormRejected = do
    ...
    let aci =
            AttributeCertificateInfo
                ...
                , aciIssuer = AttCertIssuerV1 [AltNameDN (mkDn "Test AA")] -- v1Form!
...
testV2FormBaseCertID = do
    let v2form =
            V2Form
                { v2formIssuerName = [AltNameDN (mkDn "Test AA")]
...
testSerialTooLong = do
    ...
    let aci =
            AttributeCertificateInfo
                ...
                , aciHolder = Holder (Just (IssuerSerial [] 1 Nothing)) Nothing Nothing
                , aciIssuer =
                    AttCertIssuerV2 $ V2Form [AltNameDN (mkDn "Test AA")] Nothing Nothing
                , aciSignature = SignatureALG HashSHA256 PubKeyALG_RSA
...
testIssuerNotSingleDN = do
    ...
    let v2form =
            V2Form
                { v2formIssuerName = [AltNameDN (mkDn "AA1"), AltNameDN (mkDn "AA2")]
                , v2formBaseCertificateID = Nothing
                , v2formObjectDigestInfo = Nothing
                }
    let aci =
