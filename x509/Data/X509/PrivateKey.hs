...
rsaFromASN1
    ( Start Sequence : IntVal 0 : IntVal n : IntVal e : IntVal d
            : IntVal p
            : IntVal q
            : IntVal dP
            : IntVal dQ
      ...
      where
        ...
        go m i
            ...
            | otherwise = go m (i + 1)
rsaFromASN1
    ( Start Sequence : IntVal 0 : Start Sequence
...
dsaFromASN1
    ( Start Sequence : IntVal 0 : IntVal p : IntVal q : IntVal g
            : IntVal _
            : IntVal x
            : End Sequence
            : as
  ...
  where
    ...
    go acc (Start Sequence : IntVal 1 : OctetString bytes : rest) = do
      ...
      where
        ...
        subgo
            ( Start Sequence : IntVal 1 : Start Sequence
...
ecdsaToASN1 (PrivKeyEC_Named curveName d) =
  ...
  where
    ...
    oid =
        fromMaybe
            (err $ "missing named curve " ++ show curveName)
