...
encodeGeneralNames :: [GeneralName] -> [ASN1]
encodeGeneralNames gns = [Start Sequence] ++ concatMap encodeGeneralName gns ++ [End Sequence]

parseGeneralNames :: ParseASN1 [GeneralName]
