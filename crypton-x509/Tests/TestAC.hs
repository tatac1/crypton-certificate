...
-- | QuickCheck roundtrip tests for RFC 5755 Attribute Certificate types.
module TestAC (tests) where
...
acExtensionTests =
    testGroup
        ...
        , -- \| RFC 5755 Section 4.3.2 — Target Information
          ...
          testProperty
            "targetInformation"
            (property_extension_id :: ExtTargetInformation -> Bool)
        ]
...
acAttributeTests =
    testGroup
        ...
        , -- \| RFC 5755 Section 4.4.2 — Access Identity
          ...
          testProperty
            "accessIdentity"
            (property_attribute_id :: Attr_AccessIdentity -> Bool)
        , -- \| RFC 5755 Section 4.4.3 — Charging Identity
          ...
          testProperty
            "chargingIdentity"
            (property_attribute_id :: Attr_ChargingIdentity -> Bool)
